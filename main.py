...
class TicTacToe:
    ...
    def __click_button(self, button):
        ...
        if button["text"] == " " and self.clicked == True:
            ...
            messagebox.showerror(title="Внимание!",
                                 message="Эта позиция была выбрана!\nПожалуйста, выберите другую позицию...")
    ...
    def __check_winner(self):
        ...
        if self.button_1["text"] == "X" and self.button_2["text"] == "X" and self.button_3["text"] == "X":
            ...
            self.winner = True
            messagebox.showinfo(title="Крестики-нолики",
                                message="Поздравляю! Х - победитель")
        ...
        # Top row solution for O
             ...
             self.winner = True
             messagebox.showinfo(title="Крестики-нолики",
                              message="Поздравляю! O - победитель")
             self.__disable_buttons()
